...
YES it can! Thanks to the awesome work of <a href="https://github.com/zalexdev/wpair-app" target="_blank">this git</a> I was able to build something that works and integrates well into the UI. It's in v3.1.7 NOW.
