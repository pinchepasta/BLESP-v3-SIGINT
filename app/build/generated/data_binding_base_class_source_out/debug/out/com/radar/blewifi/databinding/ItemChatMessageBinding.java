...
public final class ItemChatMessageBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvAudioIcon;
  ...
  private ItemChatMessageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivImage,
      @NonNull LinearLayout messageContainer, @NonNull TextView tvAudioIcon,
      @NonNull TextView tvMessage, @NonNull TextView tvTime) {
    this.rootView = rootView;
    this.ivImage = ivImage;
    this.messageContainer = messageContainer;
    this.tvAudioIcon = tvAudioIcon;
  ...
  public static ItemChatMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvAudioIcon;
      TextView tvAudioIcon = ViewBindings.findChildViewById(rootView, id);
      if (tvAudioIcon == null) {
        break missingId;
      }
      ...
      return new ItemChatMessageBinding((ConstraintLayout) rootView, ivImage, messageContainer,
          tvAudioIcon, tvMessage, tvTime);
    }
